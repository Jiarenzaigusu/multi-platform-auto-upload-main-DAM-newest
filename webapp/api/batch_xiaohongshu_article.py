...
XIAOHONGSHU_ARTICLE_SAMPLE_ROW = (
    "/Users/your-name/Pictures/xhs-note",
    "夏季女鞋图文",
    "轻盈舒适，适合通勤与日常穿搭。",
    "女鞋,夏季穿搭",
    "2030年12月31日 14点30分",
...
def build_xiaohongshu_article_template() -> bytes:
    return build_content_template(
        sheet_title="小红书图文批量发布",
        columns=XIAOHONGSHU_ARTICLE_BATCH_COLUMNS,
        sample_row=XIAOHONGSHU_ARTICLE_SAMPLE_ROW,
    )
...
def parse_xiaohongshu_article_batch_workbook(
    ...
    try:
        ...
        positions, header_row_number = find_header_row(
            rows,
            columns=XIAOHONGSHU_ARTICLE_BATCH_COLUMNS,
            column_aliases=XIAOHONGSHU_ARTICLE_COLUMN_ALIASES,
        ...
        for row_number, values in enumerate(rows, start=header_row_number + 1):
            row_values = {
                ...
                for field, _label, _required in XIAOHONGSHU_ARTICLE_BATCH_COLUMNS
            }
