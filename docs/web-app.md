...
天猫视频和图文均支持标题、文案、内容标签、品牌标签、活动话题、音乐、最多 6 个商品 ID、定时发布和创作者声明；视频还支持自定义封面。自定义封面支持 JPG、PNG 或 WebP，最大 20 MiB，宽高均需至少 720 像素；视频上传完成后，助手会执行“编辑封面 → 本地上传 → 应用封面”。京东支持标题、一个商品 ID、参与话题、三级标签路径（例如“兴趣标签 / 居家 / 健康环保家居”）、自主原创、定时发布和创作者声明；助手会在京麦发布页的“请选择标签”控件中逐级匹配并勾选标签。定时发布时间至少提前 2 小时。
