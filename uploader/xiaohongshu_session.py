# -*- coding: utf-8 -*-
"""Shared browser-session pool for all Xiaohongshu content types."""
...
class XiaohongshuBrowserSession(BrowserSession):
    """Browser context for one authenticated Xiaohongshu account."""

    def context_options(self) -> dict[str, object]:
        return {"permissions": ["geolocation"]}


class XiaohongshuSessionPool(BrowserSessionPool):
    """Pool shared by Xiaohongshu video and article publishers for one account."""

    session_class = XiaohongshuBrowserSession
