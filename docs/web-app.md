...
天猫支持自定义封面、标题、文案、内容标签、视频品牌标签、活动话题、音乐、最多 6 个商品 ID、定时发布和创作者声明。自定义封面支持 JPG、PNG 或 WebP，最大 20 MiB，宽高均需至少 720 像素；视频上传完成后，助手会执行“编辑封面 → 本地上传 → 应用封面”。京东支持标题、一个商品 ID、自主原创、定时发布和创作者声明。定时发布时间至少提前 2 小时。
